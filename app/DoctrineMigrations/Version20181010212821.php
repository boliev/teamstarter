...
final class Version20181010212821 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offers (id INT NOT NULL, from_id INT DEFAULT NULL, project_id INT DEFAULT NULL, project_open_role_id INT DEFAULT NULL, to_id INT DEFAULT NULL, message TEXT DEFAULT \'\' NOT NULL, status VARCHAR(255) DEFAULT \'New\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
