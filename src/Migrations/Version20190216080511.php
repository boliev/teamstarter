...
final class Version20190216080511 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promo_codes (code VARCHAR(255) NOT NULL, description TEXT NOT NULL, free_pro_months INT DEFAULT 0 NOT NULL, until TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(code))');
